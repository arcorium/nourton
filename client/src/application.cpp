...
namespace ar {
  ...
  void Application::draw_overlay() noexcept {
    ...
    notification_overlay(State::overlay_state_id(OverlayState::ClientDisconnected), "Close"sv,
    ...
    notification_overlay(State::overlay_state_id(OverlayState::EmptyField), "Close"sv,
                         ICON_FA_STOP" There's some empty field"sv,
                         "Please fill all fields and try again"sv);

    // Password Different
    notification_overlay(State::overlay_state_id(OverlayState::PasswordDifferent), "Close"sv,
    ...
    // Login Failed
    notification_overlay(State::overlay_state_id(OverlayState::LoginFailed), "Close"sv,
                         "Username/Password doesn't match"sv, "Please try again");

    // Register failed
    notification_overlay(State::overlay_state_id(OverlayState::RegisterFailed), "Close",
