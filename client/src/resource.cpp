...
namespace ar
{
	static std::expected<ImageProperties, std::string_view> load_image(std::string_view filepath) noexcept
	{
		int x, y;
	...
	std::expected<ResourceManager::image_type, std::string_view> ResourceManager::image(std::string_view name) noexcept
	{
