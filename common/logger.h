...
namespace ar
{
  ...
  public:
    ...
    static void trace(std::string_view val,
                      std::source_location sl = std::source_location::current()) noexcept;
    static void info(std::string_view val,
                     std::source_location sl = std::source_location::current()) noexcept;
    static void warn(std::string_view val,
                     std::source_location sl = std::source_location::current()) noexcept;
     ...
     * @param val string
     */
    static void error(std::string_view val,
                      std::source_location sl = std::source_location::current()) noexcept;
    static void critical(std::string_view val,
                         std::source_location sl = std::source_location::current()) noexcept;
